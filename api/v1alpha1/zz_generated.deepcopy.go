...
func (in *OptimizedAlloc) DeepCopyInto(out *OptimizedAlloc) {
	*out = *in
	...
	if in.GPUFraction != nil {
		in, out := &in.GPUFraction, &out.GPUFraction
		*out = new(float64)
		**out = **in
	}
}
...
func (in *VerticalScalingSpec) DeepCopyInto(out *VerticalScalingSpec) {
	*out = *in
	if in.BootstrapGPUFraction != nil {
		in, out := &in.BootstrapGPUFraction, &out.BootstrapGPUFraction
		*out = new(float64)
		**out = **in
	}
	...
	if in.ScaleDownStep != nil {
		in, out := &in.ScaleDownStep, &out.ScaleDownStep
		*out = new(float64)
		**out = **in
	}
	if in.MinGPUFraction != nil {
		in, out := &in.MinGPUFraction, &out.MinGPUFraction
		*out = new(float64)
		**out = **in
	}
}
